...
def Rf_prediction(train_data, test_data, stock, n_components = 10):
    ...
    rf = RandomForestRegressor(random_state=53)
    # TimeSeriesSplit
    tscv = TimeSeriesSplit(n_splits = 5)
    print(tscv)
    cv_rf = RandomizedSearchCV(estimator = rf, param_distributions = param_grid, 
                       cv = tscv, scoring='neg_mean_squared_error', random_state = 53, n_jobs = -1)
...
plt.savefig('/mnt/data/cumulative_return_plot53.png')
